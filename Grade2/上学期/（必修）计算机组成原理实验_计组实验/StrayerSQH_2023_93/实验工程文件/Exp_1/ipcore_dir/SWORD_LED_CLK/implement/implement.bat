...
xst -ifn xst.scr
move SWORD_LED_CLK_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\SWORD_LED_CLK_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc SWORD_LED_CLK_exdes.ucf SWORD_LED_CLK_exdes

echo 'Running map'
map -timing -pr b SWORD_LED_CLK_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm SWORD_LED_CLK_exdes -w routed.ncd routed.v
cd ..
