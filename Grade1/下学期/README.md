...
13. （必修）军事技能_军训
14. （必修）体育-2
16. （必修）大学物理（理工）Ⅲ-1_大物
17. （选修）大学物理实验（理工）Ⅲ-1_大物实验
18. （选修）汇编语言程序设计_汇编
19. （选修）汇编语言程序设计课程设计_汇编实验
...
同时，“汇编语言程序设计”和“微机系统与接口技术”从2024届开始合成了一门课“汇编语言与微机接口”，对应的实验课也进行了合并，在大二上学期学习。

另外，大物实验虽然是选修课程，但我们十分建议大家选这门课，为**大二上的必修大物打下基础**。

在2025年上学期, 高级语言程序设计(C++篇)的期末考试风格出现了明显转换，不再是以往的选填、判断等题型，转为了一整个项目的设计题(分为多个前后关联的部分要求填空/设计整个功能)。
